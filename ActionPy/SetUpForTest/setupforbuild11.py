...
with open(f"ActionPy/{CPP11PY}", "w+", encoding='utf-8') as file:
    file.write(f"# {CPP11PY}.py\n")
    ...
    for i, file_path in enumerate(markdown_files):
        ...
        with open(f'{file_path}', 'r', encoding='utf-8') as mdfs:
            ...
            if res is not None:
                ...
                file.write(f'@pytest.mark.parametrize("test_case", [("ActionPy/TempCppGen/{function_name}.cpp", "{CPP11} ActionPy/TempCppGen/cpp11/{function_name}Gen ActionPy/TempCppGen/{function_name}.cpp")])\n')
